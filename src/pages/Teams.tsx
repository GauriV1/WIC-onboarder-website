...
export default function Teams() {
  const currentLeadership = [
    {
      name: "Arina Gushchina",
      role: "CEO",
      bio: "Leading WIC's strategic direction and portfolio management.",
      initials: "AG"
    },
    {
      name: "Peter Hanford",
  ...
  return (
    <Layout>
      ...
      <section className="py-16 px-4">
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="mb-4">Executive Board</h2>
            <p className="text-lg text-black max-w-2xl mx-auto font-medium">
              Our executive leadership team coordinates research activities and mentor members.
            </p>
          </div>
      ...
      <section className="py-16 px-4 bg-muted/30">
        <div className="container max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="mb-4">Board Members</h2>
            <p className="text-lg text-black max-w-2xl mx-auto font-medium">
              Our board members lead specialized research areas and contribute to WIC's strategic direction.
            </p>
          </div>
